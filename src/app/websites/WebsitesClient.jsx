...
const categories = [
  { icon: Globe, name: 'Local Business Website', desc: '1–3 page sleek website tailored for local shops, barbers, cafes, tutors, and micro-businesses.', prices: { INR: 7000, USD: 249, EUR: 229 }, features: ['1–3 Pages', 'WhatsApp Button Integration', 'Google Maps Support', 'Mobile Responsive'] },
  { icon: Layout, name: 'Landing Page', desc: 'High-converting single-page website with modern design and instant WhatsApp integration.', prices: { INR: 8000, USD: 249, EUR: 229 }, features: ['High Conversion Design', 'WhatsApp Integration', 'Lead Capture Form', 'Fast 1.5s Speed'] },
  { icon: ShoppingCart, name: 'E-Commerce Store', desc: 'Full-featured online store with admin panel to add/remove products and edit site content.', prices: { INR: 13000, USD: 399, EUR: 369 }, features: ['1 Year Free Domain & Hosting', 'Admin Panel (Owner Can Edit Site)', 'Add & Remove Products Easily', 'Payment Gateways (UPI, Cards)'] },
  { icon: Palette, name: "Fashion Website (Men's & Women's)", desc: "Custom e-commerce & showcase platform for men's and women's apparel brands.", prices: { INR: 13000, USD: 399, EUR: 369 }, features: ['1 Year Free Domain & Hosting', 'Admin Panel (Owner Can Edit Site)', 'Add & Remove Apparel & Sizes', 'WhatsApp Quick Order + Payments'] },
  { icon: RefreshCw, name: 'Website Redesign', desc: 'Modernize your outdated website with superior design, fast performance, and UX revamp.', prices: { INR: 15000, USD: 399, EUR: 369 }, features: ['Complete Visual Overhaul', 'Speed & Mobile Optimization', 'Core Web Vitals Boost', 'SEO Migration'] },
  { icon: Globe, name: 'Business Website', desc: 'Professional multi-page business site with admin panel to edit content and blogs.', prices: { INR: 23000, USD: 549, EUR: 499 }, features: ['1 Year Free Domain & Hosting', 'Admin Panel (Owner Can Edit Site)', 'Multi-Page Structure (8–10 Pages)', 'Full Technical SEO'] },
  { icon: Zap, name: 'Premium 3D Website', desc: 'Immersive WebGL / Three.js 3D experience with bespoke visual motion design.', prices: { INR: 35000, USD: 699, EUR: 649 }, features: ['1 Year Free Domain & Hosting', 'WebGL / Three.js 3D Motion', 'Interactive Scroll Effects', 'Bespoke UI/UX Engineering'] },
];
