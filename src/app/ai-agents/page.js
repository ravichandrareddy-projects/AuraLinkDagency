...
const agents = [
  { id: 'voice-calling', name: 'Voice Calling Agent', tagline: 'Automate outbound & inbound calls', capabilities: ['Outbound calling campaigns', 'Appointment booking & reminders', 'Automated follow-ups', 'Customer support handling'] },
  { id: 'whatsapp', name: 'WhatsApp Agent', tagline: 'Engage customers on WhatsApp 24/7', capabilities: ['Automated conversations', 'Lead capture & qualification', 'Customer support chatbot', 'Order updates & tracking'] },
  { id: 'social-media', name: 'Social Media Manager', tagline: 'Automate your social presence', capabilities: ['AI post generation', 'Smart scheduling', 'Content planning & calendar', 'Performance analytics'] },
  { id: 'sales', name: 'Sales Agent', tagline: 'Close more deals on autopilot', capabilities: ['Lead qualification & scoring', 'Follow-up automation', 'CRM integration', 'Meeting booking'] },
  { id: 'onboarding', name: 'Onboarding Agent', tagline: 'Streamline employee & client onboarding', capabilities: ['Employee onboarding flows', 'Customer onboarding', 'Document collection', 'Progress tracking'] },
  { id: 'video-generation', name: 'Video Generation Agent', tagline: 'Create videos with AI', capabilities: ['Reels & shorts creation', 'Marketing video production', 'Product demo videos', 'AI-powered editing'] },
  { id: 'data-scraping', name: 'Data Scraping Agent', tagline: 'Extract business intelligence', capabilities: ['Lead scraping at scale', 'Business data extraction', 'Competitor monitoring', 'Market research'] },
  { id: 'lead-generation', name: 'Lead Generation Agent', tagline: 'Fill your pipeline automatically', capabilities: ['Multi-channel lead capture', 'Lead scoring & prioritization', 'Funnel automation', 'Campaign tracking'] },
  { id: 'data-scraper', name: 'Data Scraper Agent', tagline: 'Build your data advantage', capabilities: ['Web scraping automation', 'Data enrichment', 'Automated reporting', 'Database building'] },
];
